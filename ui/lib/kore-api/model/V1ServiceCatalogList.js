...
import V1ServiceCatalog from './V1ServiceCatalog';

/**
 * The V1ServiceCatalogList model module.
 * @module model/V1ServiceCatalogList
 * @version 0.0.1
 */
class V1ServiceCatalogList {
    /**
     * Constructs a new <code>V1ServiceCatalogList</code>.
     * @alias module:model/V1ServiceCatalogList
     * @param items {Array.<module:model/V1ServiceCatalog>} 
     */
    constructor(items) { 
        
        V1ServiceCatalogList.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>V1ServiceCatalogList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1ServiceCatalogList} obj Optional instance to populate.
     * @return {module:model/V1ServiceCatalogList} The populated <code>V1ServiceCatalogList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ServiceCatalogList();

            if (data.hasOwnProperty('apiVersion')) {
                obj['apiVersion'] = ApiClient.convertToType(data['apiVersion'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [V1ServiceCatalog]);
            }
...
/**
     * @return {Array.<module:model/V1ServiceCatalog>}
     */
    getItems() {
        return this.items;
    }
    ...
    /**
     * @param {Array.<module:model/V1ServiceCatalog>} items
     */
    setItems(items) {
        this['items'] = items;
    }
 ...
 */
V1ServiceCatalogList.prototype['apiVersion'] = undefined;

/**
 * @member {Array.<module:model/V1ServiceCatalog>} items
 */
V1ServiceCatalogList.prototype['items'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1ServiceCatalogList.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ListMeta} metadata
 */
V1ServiceCatalogList.prototype['metadata'] = undefined;
...
export default V1ServiceCatalogList;
