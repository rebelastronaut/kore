...
import V1ServiceCatalogSpec from './V1ServiceCatalogSpec';
import V1ServiceCatalogStatus from './V1ServiceCatalogStatus';

/**
 * The V1ServiceCatalog model module.
 * @module model/V1ServiceCatalog
 * @version 0.0.1
 */
class V1ServiceCatalog {
    /**
     * Constructs a new <code>V1ServiceCatalog</code>.
     * @alias module:model/V1ServiceCatalog
     */
    constructor() { 
        
        V1ServiceCatalog.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1ServiceCatalog</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1ServiceCatalog} obj Optional instance to populate.
     * @return {module:model/V1ServiceCatalog} The populated <code>V1ServiceCatalog</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ServiceCatalog();
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = V1ServiceCatalogSpec.constructFromObject(data['spec']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1ServiceCatalogStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:model/V1ServiceCatalogSpec}
     */
    getSpec() {
        return this.spec;
    }
    ...
    /**
     * @param {module:model/V1ServiceCatalogSpec} spec
     */
    setSpec(spec) {
        this['spec'] = spec;
    }
/**
     * @return {module:model/V1ServiceCatalogStatus}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:model/V1ServiceCatalogStatus} status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
V1ServiceCatalog.prototype['apiVersion'] = undefined;

/**
 * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
 * @member {String} kind
 */
V1ServiceCatalog.prototype['kind'] = undefined;

/**
 * @member {module:model/V1ObjectMeta} metadata
 */
V1ServiceCatalog.prototype['metadata'] = undefined;

/**
 * @member {module:model/V1ServiceCatalogSpec} spec
 */
V1ServiceCatalog.prototype['spec'] = undefined;

/**
 * @member {module:model/V1ServiceCatalogStatus} status
 */
V1ServiceCatalog.prototype['status'] = undefined;
...
export default V1ServiceCatalog;
