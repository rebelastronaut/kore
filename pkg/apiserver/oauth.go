...
func (l *oauthHandler) Path() string {
	return "oauth"
}

// Register is responsible for handling the registration
func (l *oauthHandler) Register(i kore.Interface, builder utils.PathBuilder) (*restful.WebService, error) {
...
func (l *oauthHandler) authorizerHandler(req *restful.Request, resp *restful.Response) {
...
func (l *oauthHandler) callbackHandler(req *restful.Request, resp *restful.Response) {
	// @step: check if the handler has been configured
	if l.oidcConfig == nil {
		resp.WriteHeader(http.StatusNotImplemented)
...
func (l *oauthHandler) EnableAdminsOnly() bool {
	return false
}

// EnableAuthentication indicates if this service needs auth
func (l *oauthHandler) EnableAuthentication() bool {
	return false
}

// Name returns the name of the handler
func (l *oauthHandler) Name() string {
	return "login"
}
...
func (l *oauthHandler) makeHostURL(req *restful.Request) string {
	scheme := "http"
